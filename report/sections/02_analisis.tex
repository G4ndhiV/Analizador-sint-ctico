...
La gramática formal completa (33 no terminales, todas las producciones de \texttt{parser.y}) se documenta en el \textbf{Apéndice~\ref{ap:cfg-completa}} (Listado~\ref{lst:cfg-completa}). El siguiente extracto resume las construcciones principales para lectura rápida en el análisis.
